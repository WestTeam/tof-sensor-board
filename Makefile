...
PROJECT = tof-sensor-board
CONFDIR  := ./cfg
PROJECTDIR = ./

# Imported source files and paths
CHIBIOS = 3rdparty/ChibiOS
...
CPPSRC = $(ALLCPPSRC) \
		 src/Alive.cpp \
		 src/modules/protocol/Protocol.cpp \
		 src/modules/sensors/TCS3472.cpp \
...
#### Specifics routines for WestBot

.PHONY: flash
flash: all
	st-flash write $(BUILDDIR)/$(PROJECT).bin 0x8000000
	#dfu-util -d 0483:df11 -s 0x08000000 -a 0 -D $(BUILDDIR)/$(PROJECT).bin
